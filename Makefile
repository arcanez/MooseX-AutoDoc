# This Makefile is for the MooseX::AutoDoc extension to perl.
#
...
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], Template=>q[0], Moose=>q[0.36] }
#     VERSION => q[undef]
#     dist => { PREOP=>q[$(PERL) -I. "-MModule::Install::Admin" -e "dist_preop(q($(DISTVNAME)))"] }
#     test => { TESTS=>q[t/000-load.t t/001-basic.t t/002-attributes.t t/003-moosex-types.t t/100-class.t t/101-class.t t/102-class.t t/103-class.t t/104-class.t t/105-class.t t/200-role.t t/201-role.t t/202-role.t] }
...
DISTNAME = MooseX-AutoDoc
DISTVNAME = MooseX-AutoDoc-undef
...
TEST_FILE = test.pl
TEST_FILES = t/000-load.t t/001-basic.t t/002-attributes.t t/003-moosex-types.t t/100-class.t t/101-class.t t/102-class.t t/103-class.t t/104-class.t t/105-class.t t/200-role.t t/201-role.t t/202-role.t
TESTDB_SW = -d
